----------Item------------
local nuclear_void_miner_item = {
    icon = "__void-miners-extended__/graphics/icons/nuclear-void-miner.png",
    icon_size = 64,
    name = "void-miners-nuclear-void-miner",
    order = "c-f",
    place_result = "void-miners-nuclear-void-miner",
    stack_size = 50,
...
----------Recipe------------
local nuclear_void_miner_recipe = {
	enabled = false,
	energy_required = 60,
	ingredients = {
		{"uranium-235", 40},
	...
	name = "void-miners-nuclear-void-miner",
	result = "void-miners-nuclear-void-miner",
	type = "recipe",
}
...
local nuclear_void_miner_entity = {
	...
	animation = {
		...
		filename = "__void-miners-extended__/graphics/entity/nuclear-void-miner/nuclear-void-miner.png",
		priority = "high",
		height = 122,
		hr_version = {
			animation_speed = 0.75,
			filename = "__void-miners-extended__/graphics/entity/nuclear-void-miner/hr-nuclear-void-miner.png",
			priority = "high",
			height = 242,
			width = 365,
			frame_count = 16,
...
----------Add To Game------------
data:extend({
	nuclear_void_miner_item,
	nuclear_void_miner_recipe,
	nuclear_void_miner_entity,
})